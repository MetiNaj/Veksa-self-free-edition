...
<hr style="border: 1px solid #ccc;" /> <h2>📷 پیش‌نمایش</h2> <img src="https://freeimage.host/i/FVxBRVa" alt="screenshot" style="border-radius: 12px; box-shadow: 0 0 10px #ccc; width: 70%;"/> <hr style="border: 1px solid #ccc;" /> <h2>👨‍💻 توسعه‌دهنده</h2> <p>این پروژه توسط <b>Mahdi Najari</b> توسعه داده شده است.</p> <p>📫 ارتباط با من در <a href="https://linkedin.com/in/mahdi-najari" target="_blank">LinkedIn</a></p> </div> ```
